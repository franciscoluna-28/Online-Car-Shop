...
let carSelectors = [carSelector1, carSelector2, carSelector3, carSelector4, carSelector5, carSelector6, carSelector7, carSelector8, carSelector9]
    ...
    elem.addEventListener("click", function() {
        ...
        checkoutIcon.addEventListener("click", function(){
            if(navMenu.children.length > 0){
               alert("Thanks for your purchase! You have selected a total of " + navMenu.children.length + " items.")
            }else{
